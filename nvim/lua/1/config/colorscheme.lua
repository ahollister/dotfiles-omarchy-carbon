...
M.default_color = vim.g.omarchy_colorscheme or "tokyonight-moon"
...
M.set_keymaps = function()
	vim.keymap.set("n", "<leader>cc", M.cycle_colors, { silent = false })
	vim.keymap.set("n", "<leader>cd", M.set_default, { silent = true })
	vim.keymap.set("n", "<leader>cb", M.cycle_backgrounds, { silent = true })
	vim.keymap.set("n", "<leader>ct", M.toggle_transparency, { silent = true })
end
...
M.fix_colors = function(background)
	...
	-- Manage Transparency
	vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelp", { bg = background })
	vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelpBorder", { bg = background, fg = "#70788a" })
	vim.api.nvim_set_hl(0, "BlinkCmpLabelDetail", { bg = background })
	vim.api.nvim_set_hl(0, "BlinkCmpLabel", { bg = background })
	vim.api.nvim_set_hl(0, "BlinkCmpDoc", { bg = background })
	vim.api.nvim_set_hl(0, "BlinkCmpMenu", { bg = background, fg = "#ffffff" })
	vim.api.nvim_set_hl(0, "BlinkCmpMenuBorder", { bg = background, fg = "#70788a" })
	vim.api.nvim_set_hl(0, "BlinkCmpDocBorder", { bg = background, fg = "#70788a" })
...
M.cycle_colors = function()
	...
	local new_color = nil
	for index, color in pairs(M.colors) do
